 ...
 */
define('modules/agent/loadnewmore', ['jquery'], function (require, exports, module) {
    'use strict';
    module.exports = function (options) {
        ...
        var totalpage = Math.ceil(vars.count / 10),
            curp = 2,
            k = true,
            $window = $(window),
            $document = $(document),
        ...
        function loadmore() {
            ...
            $.get(options.url + '&r=' + Math.random(), {
                ...
                if (data.errorcode) {
                    $('#content').append(data.content).find('.img img').lazyload();
                    draginner.html('查看更多');
