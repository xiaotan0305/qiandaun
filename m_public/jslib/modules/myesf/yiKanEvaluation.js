 ...
 */
define('modules/myesf/yiKanEvaluation', ['jquery', 'modules/esf/yhxw', 'util/util'], function (require,exports, module) {
    'use strict';
    module.exports = function () {
        ...
        suggest.on('focus', function () {
            ...
            var numbers = suggest.text().length;
            if (numbers > 150) {
        ...
        submitBtn.on('click', function () {
            // (1) 验证数据
            var length = suggest.text().length;
            if (length > 150) {
                alert('您最多输入150字!');
                return;
            }
            ...
            // 评价内容
            var evaluationContent = suggest.text().trim();
