 ...
 * wap开盘预告页
 */
define('modules/xf/jfinfo', ['jquery', 'loadMore/1.0.1/loadMore', 'superShare/1.0.1/superShare', 'weixin/2.0.0/weixinshare'], function (require) {
	'use strict';
	var $ = require('jquery');
    ...
    var kpTotal = vars.count > 0 ? vars.count : 1;
	 loadMore.add({
         ...
         url: '/xf.d?m=jfinfo&city='+vars.city+'&res=json',
         // 每页加载数据条数
         perPageNum: 20,
         // 总数据条数
         total: kpTotal,
