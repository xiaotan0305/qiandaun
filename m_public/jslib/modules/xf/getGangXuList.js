 ...
 * wap动态页
 */
define('modules/xf/getGangXuList', ['jquery', 'loadMore/1.0.1/loadMore', 'superShare/1.0.1/superShare', 'weixin/2.0.0/weixinshare','app/1.0.0/appdownload'], function (require) {
    'use strict';
    var $ = require('jquery');
    ...
    var loadMore = function () {
        if (nowPage < totalPage) {
            ...
            //$('.dq-more').hide();
            $('#drag').show();
            $.post('/xf.d?m=getGangXuList&city=' + city + '&page=' + nowPage + '&res=json', function (data) {
                if (data) {
