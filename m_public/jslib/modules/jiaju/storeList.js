 ...
 * @author zhangxiaowei
 */
define('modules/jiaju/storeList', ['jquery', 'loadMore/1.0.0/loadMore', 'lazyload/1.9.1/lazyload', 'modules/map/API/BMap', 'util/util'], function (require, exports, module) {
    'use strict';
    module.exports = function () {
        ...
        function loadMoreFn() {
            loadMore({
                // 接口地址
                // 需要传入经纬度以及定位城市中文
                url: vars.jiajuSite + '?c=jiaju&a=ajaxStoreList&city=' + vars.city + '&lng=' + lng + '&lat=' + lat + '&locationCity=' + encodeURIComponent(locationCity) + '&address=' + encodeURIComponent(address) + isSfapp + '&platformid=' + vars.platformid + '&sourceid=' + vars.sourceid + '&positionid=' + vars.positionid + '&activityid=' + vars.activityid + '&activitydes=' + vars.activitydes + '&districtid=' + vars.districtid + '&areaid=' + vars.areaid + '&categoryid=' + vars.categoryid + '&type=' + vars.type,
                // 数据总条数
                total: vars.total,
                // 首屏显示数据条数
                pagesize: 10,
