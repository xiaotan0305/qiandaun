    ...
    function (require, exports, module) {
        ...
        module.exports = function () {
            ...
            function assemblyUrl(aId) {
                ...
                urlvalue = vars.esfSite + '?c=esf&city=' + vars.city + '&subway_id=' + results.subwayId + '&station_id=' + results.stationId + '&district=' + results.districtId + '&comarea=' + results.comareaId;
                ...
                urlvalue = urlvalue + '&a=jjfList&fromsource=' + vars.fromsource;
            ...
            $allCont.on('click', '.sx', function () {
                ...
                if ($allCont.find('#search_category').find('a.active').html() === '别墅') {
                    ...
                    for (var i in results) {
                        if (results.hasOwnProperty(i) && results[i].length > 0) {
                            ...
                            if (key !== 'comarea' && key !== 'district' && key !== 'jjfprice') {
                                if (typeof results[i] === 'object') {
                                    selAllUrl += '&' + key + '=' + results[i].join('_');
                                } else {
                                    selAllUrl += '&' + key + '=' + results[i];
                ...
                //降价房更多参数
                if ($('#ischeapest').hasClass('active')) {
                    selAllUrl = selAllUrl + '&ischeapest=1';
                }
                if ($('#isprojcheapest').hasClass('active')) {
                    selAllUrl = selAllUrl + '&isprojcheapest=1';
                }
                if ($('#maxdealpricepercentage').val()) {
                    selAllUrl = selAllUrl + '&maxdealpricepercentage=' + $('#maxdealpricepercentage').val();
                }
            ...
            $allCont.on('click', '.cz', function () {
                ...
                $('#maxdealpricepercentage').val('');
                $('#maxprojpricepercentage').val('');
            });
            ...
            $('#qrtj').on('click', function () {
                ...
                if (vars.maxdealpricepercentage) {
                    url = url + '&maxdealpricepercentage=' + vars.maxdealpricepercentage;
                }
            ...
            // 输入项的字符和位数限制
            $('#maxdealpricepercentage, #maxprojpricepercentage').on('input', function () {
                var $that = $(this);
                var val = $that.val();
                var reg = /^[1-9]\d{0,1}$/;
                if (!reg.test(val)) {
