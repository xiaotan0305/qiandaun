...
(function () {
    ...
    RichMarker.prototype._setEventDispath = function () {
        ...
        baidu.on(div, "ontouchend", function (e) {
             ...
             * });
             */
            _dispatchEvent(me, "ontouchend", {srcElement:e.srcElement});
            _dispatchEvent(me, "onclick", {srcElement:e.srcElement});
            _stopAndPrevent(e);
        });
        // 双击事件
        ...
        // yuanhuihui: 按键结束:类似鼠标弹起mouseUpEvent
        var touchendEvent = function (e) {
            ...
            if (me._container) {
                baidu.un(div, "ontouchmove", touchMoveEvent);
                baidu.un(div, "ontouchend", touchendEvent);
            }
        ...
        // yuanhuihui: 滑动事件,同鼠标移动事件
        var touchMoveEvent = function (e) {
            // 判断是否需要进行拖拽事件的处理
            if (!me._opts.enableDragging || !isTouchStart) {
                return;
            }
            var position = _getPositionByEvent(e);
        ...
        // yuanhuihui: touchStart事件,同鼠标按下事件
        baidu.on(div, "ontouchstart", function (e) {
            var position = _getPositionByEvent(e);
            /**
             ...
             *
             * @example <b>参考示例：</b>
             * myRichMarkerObject.addEventListener("ontouchstart", function(e) {
                 *     alert(e.type);
                 * });
             */
            _dispatchEvent(me, "ontouchstart", {
                "point": position.point,
                "pixel": position.pixel
            });

            baidu.on(div, "ontouchmove", touchMoveEvent);
            baidu.on(div, "ontouchend", touchendEvent);
