...
(function (w, f) {
    ...
    if (typeof define === 'function') {
        define('weixin/2.0.2/weixinshare', ['jquery'], function (require) {
            var $ = require('jquery');
            return f($, require);
        });
    ...
    Weixin.prototype = {
        ...
        runWxAPI: function () {
            ...
            wx.onMenuShareAppMessage({
                title: that.options.detailOptions.onMenuShareAppMessage.shareTitle ? that.options.detailOptions.onMenuShareAppMessage.shareTitle : that.options.shareTitle,
                desc: that.options.detailOptions.onMenuShareAppMessage.descContent ? that.options.detailOptions.onMenuShareAppMessage.descContent : that.options.descContent,
            ...
            wx.onMenuShareTimeline({
                title: that.options.detailOptions.onMenuShareTimeline.shareTitle ? that.options.detailOptions.onMenuShareTimeline.shareTitle : (that.options.swapTitle ? that.options.descContent : that.options.shareTitle),
                desc: that.options.detailOptions.onMenuShareTimeline.descContent ? that.options.detailOptions.onMenuShareTimeline.descContent : (that.options.swapTitle ? that.options.shareTitle : that.options.descContent),
                link: that.options.lineLink,
                imgUrl: that.https2http(that.options.imgUrl),
