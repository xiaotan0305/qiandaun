 ...
 * by blue
 */
define('search/esfhd/sfbHPXQListSearch', ['jquery', 'search/search'], function (require, exports, module) {
    'use strict';
    // jquery索引
    var $ = require('jquery');
    // 公共方法对象索引
    ...
    function sfbHPXQListSearch() {
        ...
        this.html = '<div class="searchPage">'
            ...
            + '<input type="search" name="q" value="" placeholder="请输入小区名查询" autocomplete="off">'
        ...
        this.historyMark = vars.city + 'sfbHPXQListHistory';
        // 显示弹窗的按钮
     ...
     */
    $.extend(sfbHPXQListSearch.prototype, search);

    /**
     * 重写创建自动提示列表方法，传入需要的接口地址及接口传参
     * @param inputValue
     */
    sfbHPXQListSearch.prototype.createAutoPromptList = function (inputValue) {
     ...
     */
    sfbHPXQListSearch.prototype.getAutoPromptListContent = function (dataArr) {
        var that = this;
     ...
     * 增加热词点击和显示热词操作
     */
    sfbHPXQListSearch.prototype.showPop = function () {
        var that = this;
     ...
     */
    sfbHPXQListSearch.prototype.inputChange = function () {
        var that = this;
     ...
     * 增加显示历史记录操作
     */
    sfbHPXQListSearch.prototype.closeAutoPromptList = function () {
        var that = this;
     ...
     * 点击搜索按钮处理
     */
    sfbHPXQListSearch.prototype.search = function () {
        var that = this;
        // 获取用户输入内容
        ...
        var url = vars.esfSite + '?c=esfhd&a=sfbHPXQList';
        if (b) {
     ...
     * @returns {string}
     */
    sfbHPXQListSearch.prototype.getHistoryContent = function (arr) {
        var that = this,
            len = arr.length,
            html = '',
        // lihtml模板字符串
     ...
     * @param obj
     */
    sfbHPXQListSearch.prototype.clickListSearch = function (obj) {
        var that = this;
        that.searchInput.val(obj.key);
        that.search();
    };
    module.exports = sfbHPXQListSearch;
})
;