 ...
 * by zhangcongfeng
 */
define('search/myesf/xqHandSearch', ['jquery', 'search/search'], function (require, exports, module) {
    'use strict';
    // jquery索引
    var $ = require('jquery');
    // 公共方法对象索引
     ...
     * 点击搜索按钮处理
     */
    xqSearch.prototype.search = function (obj) {
        var that = this;
        that.searchInput.val(obj.projname);
        that.showPopBtn.val(obj.projname);
        vars.ProjCode = obj.projcode;
        vars.ProjName = obj.projname;
        vars.District = obj.district;
        vars.ComArea = obj.comarea;
        that.back();
    }
