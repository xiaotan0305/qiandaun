...
define('search/jiaju/jiajuSearch', ['jquery', 'search/search'], function (require, exports, module) {
    ...
    var channelList = {
        ...
        xgtList: ['单图','风格/功能间/局部等'],
        zxbj: ['套图','户型/风格等'],
        visitGd: ['工地','请输入楼盘/姓名等'],
        lglist: ['灵感','风格/户型/功能间等'],
        buildPartList: ['主材','请输入建材品牌'],
        companyNewList: ['同城装修公司','同城装修公司名称'],
        firmList: ['同城装饰公司','同城装饰公司名称'],
        shopList: ['店铺','输入关键词搜索店铺名称/地址'],
        productList: ['产品','输入关键词搜索品牌/型号/产品名称'],
        sjsList: ['设计师', '请输入设计师或公司名称'],
        zxCaseList: ['装修案例', '请输入楼盘、设计师或者公司名称']
    };
    var clickList = {
    ...
    var mtLocation = {
        xgtList: '/jiaju/' + vars.city + '/xgt.html',
        zxbj: '/jiaju/' + vars.city + '/zxbj.html',
        lglist: '/jiaju/' + vars.city + '/lglist.html',
        companyNewList: '/jiaju/?c=jiaju&a=companyNewList&city=' + vars.city  + (location.href.match(/[&?]from=[a-z]+/i) || []).join('')
    };
    ...
    function JjSearch() {
        ...
        this.html = '<div>'
            ...
            + '<div style="margin-bottom: 50px;"><div class="searList" id="' + clickId.hisList + '"><ul></ul></div><div class="clearBtn2" id="' + clickId.clearHis + '">'
        ...
        // 装修美图
        mtLocation[vars.action] && (this.location = mtLocation[vars.action]);
    }
    ...
    JjSearch.prototype.showPop = function () {
        ...
        if ($.inArray(vars.action,['zxbj','xgtList','lglist']) === -1) {
    ...
    JjSearch.prototype.closeAutoPromptList = function () {
        ...
        if ($.inArray(vars.action,['zxbj','xgtList','lglist','companyNewList']) === -1) {
            that.creatHistoryList();
        }
    };
    ...
    JjSearch.prototype.search = function () {
        ...
        } else if(!b && $.inArray(vars.action,['firmList','productList','shopList']) !== -1) {
            location.href = vars.defaultIndex;
        }
    };
