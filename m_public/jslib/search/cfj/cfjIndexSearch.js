 ...
 * by blue
 */
define('search/cfj/cfjIndexSearch', ['jquery', 'search/search'], function (require, exports, module) {
    'use strict';
    // jquery索引
    var $ = require('jquery');
    // 公共方法对象索引
    ...
    CfjSearch.prototype.search = function () {
        ...
        var url = vars.pingguSite + '?c=pinggu&a=indexList&keyword=' + encodeURIComponent(b);
