 ...
 */
define("touchslide/1.0/touchslide",[],function(require,exports,module){
    var TouchSlide = function(a){
        ...
        var opts = {
            ...
            redirectURL:a.redirectURL || false // 跳转地址
        }
            ...
            if( !scrollY ){
                ...
                switch (effect){
                    case "left":
                        ...
                        break;
                    case "leftLoop":
                        if(index==navObjSize-1&&distX<0&&opts.redirectURL){window.location.href = opts.redirectURL;}
                        translate( -(index+1)*slideW+distX ,0 );break;
                }
