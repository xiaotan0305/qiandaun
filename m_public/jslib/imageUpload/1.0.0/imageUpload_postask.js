/**
 * Created by hanxiao on 2017/11/29.
 */
define('imageUpload/1.0.0/imageUpload_postask', ['jquery', 'imageUpload/jpegMeta','imageUpload/imageCompresser'], function (require) {
    'use strict';
    var $ = require('jquery'),
    ...
    ImageUpload.prototype = {
        ...
        prepareUpload: function (file, uploadBase64) {
            ...
            $('.uploadpic').append('<div class="tdpic"><img style="width:38px;height:38px" src="'+ this.options.loadingImg + '" /></div>');
            this.upload(fileObj);
        },
