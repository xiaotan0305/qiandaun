...
// version: 3.0.5
define("photoswipe/3.0.5/photoswipe",["klass/1.0/klass","hammer/0.3/hammer"],function(require,exports,modules){
(function(window){
var i;
    window.klass = require("klass/1.0/klass");
(function (window) {
                    ...
                    case Util.TouchElement.ActionTypes.tap:
                        ...
                        if(footerTool.css("display") == "block"){
                            if(window.localStorage)
                                localStorage.setItem("jiajuCaptionToolbar",'hidden');
                            footerTool.fadeOut();
