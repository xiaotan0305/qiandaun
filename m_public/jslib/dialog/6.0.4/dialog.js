 ...
 *
 * @file artDialog - 对话框(不含拖拽功能)主模块
 * @author 袁辉辉(yuanhuihui@soucun.com)
 */
define('dialog/6.0.4/dialog', ['jquery', 'dialog/6.0.4/popup', 'dialog/6.0.4/dialog-config'], function (require, exports, module) {
    'use strict';
    var $ = require('jquery');
    var Popup = require('dialog/6.0.4/popup');
    var defaults = require('dialog/6.0.4/dialog-config');
    var css = defaults.cssUri;


// css loader: RequireJS & SeaJS
    if (css) {
        css = seajs.data.vars.public+css;
