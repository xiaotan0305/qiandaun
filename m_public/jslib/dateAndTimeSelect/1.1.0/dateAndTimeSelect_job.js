...
(function (w, f) {
    ...
    if (typeof define === 'function') {
        //  AMD
        define('dateAndTimeSelect/1.1.0/dateAndTimeSelect_job', ['iscroll/2.0.0/iscroll-lite'], function (require) {
            return f(w, require);
        });
     ...
     * @type {string}
     */
    var dateHtml = '<div id="floatSelect" class="floatSelect"><div class="blue_dataSelectCon">'
            ...
            that.con.find('.blue_operateCon').on('click', 'a', function () {
                ...
                if ($parent.index() === 0) {
                    ...
                    if(beginTime.length){
                        ...
                        if (selectMounth < 10) {
                            selectMounth = '0' + selectMounth;
                        }
                        if (selectDate < 10) {
                            selectDate = '0' + selectDate;
                        }
                        // 拼接成某年某月某日的形式
                        var selectObj = selectYear +'-'+ selectMounth +'-'+ selectDate;
