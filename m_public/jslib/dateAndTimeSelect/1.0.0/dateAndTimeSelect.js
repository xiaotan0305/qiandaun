...
(function (w, f) {
    ...
    if (typeof define === 'function') {
        //  AMD
        define('dateAndTimeSelect/1.0.0/dateAndTimeSelect', ['iscroll/2.0.0/iscroll-lite'], function (require) {
            return f(w, require);
        });
     ...
     */
    w.IScrollLite = w.IScrollLite ? w.IScrollLite : require('iscroll/2.0.0/iscroll-lite');
