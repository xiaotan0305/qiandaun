 ...
 */
define('datePicker/1.0.1/datePicker', ['jquery', 'iscroll/2.0.0/iscroll-lite'], function (require, exports, module) {
    'use strict';
    // 滑动选择器类
    ...
    DatePicker.prototype = {
        ...
        init: function () {
            ...
            that.con = $('.dateBox');
            that.bg = $('.layer');
            that.dateTxtArr = $('.dateTxt span');
            that.yearTxtArr = $('.year');
        ...
        setPosition: function (is) {
            ...
            //// 当选择年时，重置天数
            //if (parent.index() === 0) {
            //    var m1 = formatNumber(that.ulArr.eq(3).attr('data-val')),
            //        d1 = formatNumber(that.ulArr.eq(4).attr('data-val'));
            //    that.setPositionByDate(str + that.delimiter + '01', m1 + that.delimiter + d1);
            //}
            ...
            //}
            //if (parent.index() === 3) {
            //    var m = formatNumber(that.ulArr.eq(0).attr('data-val')),
            //        d = formatNumber(that.ulArr.eq(1).attr('data-val'));
            //    that.setPositionByDate(m + that.delimiter + d, str + that.delimiter + '01');
            //}
            //// 判断当滚动的是结束日期的天数选择器时
            //if (parent.index() === 3) {
            //    //获取开始时间月份及结束日期的月份和天数
            //    m = formatNumber(that.ulArr.eq(0).attr('data-val'));
            //    m1 = formatNumber(that.ulArr.eq(2).attr('data-val'));
            //    d1 = formatNumber(that.ulArr.eq(3).attr('data-val'));
            //    //当开始日期月份等于结束日期月份时，要将开始日期的天数重置
            //    if (m === m1) {
            //        var ul = that.ulArr.eq(1);
            //        /**
            //         * 获取开始时间月份选择器中的ul子节点li，通过判断是否大于今天的月份来重置月份选择器要显示多少月份
            //         */
            //        ul.find('ul').children().filter(function () {
            //            var $this = $(this);
            ...
            //        ul.find('li').eq(Number(str) + 2).addClass('on');
            //        ul.attr('data-val', str);
            //        that.iscrollArr[1].refresh();
            //        that.iscrollArr[1].scrollTo(0, -(Number(str) - 1) * that.singleLiHeight);
            //
            //    }
            //}
        },
