(function(window, factory) {
    if ( typeof define === 'function') {
        // AMD
        define('app/1.0.4/appdownload',[],function(req) {
...
(function (window, factory) {
        ...
        download: function (time) {
            ...
            if (!time || now - time < this.timeout + 200) {
                if (this.cover) {
                    ...
                    if (this.ios9above) {
                        window.open(this.bannerUrl, '_top');
                    } else {
    ...
    return function (config) {
        ...
        self.ios9above = !1;
        var ios8below_reg = /OS [0-9]_\d[_\d]* like Mac OS X/gi;
        //  !uc && !qq &&
        ...
        if (/MicroMessenger/i.test(d)) {
            ...
            // 安卓跳转地址
            self.bannerUrl = "http://m.app.mi.com/";
            // ios跳转地址
        } else {
            if(self.ios9above){
                self.bannerUrl = 'itms-appss://itunes.apple.com/cn/app/search';
            }else{
                self.bannerUrl = 'itms-appss://itunes.apple.com';
            }
        }
