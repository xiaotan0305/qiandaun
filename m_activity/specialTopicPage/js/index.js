/**
 * Created by sunwenxiu on 2017/4/12.
 */
$(function () {
    'use strict';
    var encity = '';
    ...
    var weixin = new Weixin({
        ...
        debug: false,
        shareTitle: '你在春天有个约惠，还不快去？',
        descContent: '春暖花开优惠来，真特价，真房源，最高首月租金5折。 ',
        lineLink: location.href,
        imgUrl: $('#srcSite').val() + '/common_m/m_activity/specialTopicPage/images/share.jpg',
        swapTitle: true
    });
