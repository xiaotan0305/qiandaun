...
(function (factory) {
    if (typeof define === 'function') {
        define('imageUpload/jpegMeta', [], function () {
            return factory();
        });
    } else {
        window.JpegMeta = factory(jQuery);
    }
})(function () {
    'use strict';
    var JpegMeta = {};
    ...
    JpegMeta.JpegFile.prototype._parseIfd = function _parseIfd(endian, _binary_data, base, ifd_offset, tags, name, description) {
