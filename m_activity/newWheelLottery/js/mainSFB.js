...
$(document).ready(function () {
    ...
    var isEsf = '';
    var prizeType = '';
    var loginurl = 'https://m.fang.com/passport/login.aspx?burl=' + encodeURIComponent(locationurl);
            ...
            if (times + 1 > finTime) {
                ...
                if (isStop && isEsf == '0') {    //没有二手房参与抽奖资格
                    setTimeout(function () {
                        ...
                        $js_prizeResultOrNot.css('line-height', '1rem');
    ...
    function lotterygoon() {
        ...
        //抽奖---------------------发送请求
        var url = "/huodongAC.d?m=newWheelLuckDraw&class=NewWheelLotteryHc&projCode=" + _var_projCode +"&isSFB="+isSFB+"&isAgent="+isAgent+"&aw_city="+aw_city;
		$.getJSON(url, {
            ...
            var prizeUrl = data.root.prizeUrl.replace(/&amp;/g, '&');
            ...
            $("#dianping").one("click", function () {
                window.location.href = "http://m.test.fang.com/fangjia/bj_list_pinggu/";
            });
    ...
    $("#login_btn").on("click", function () {
        ...
        isSending = false;
        smsLogin.check(phone, vcode, function () {
            // 验证码验证成功
