 ...
 * 对象化
 */
define('SearchOther', ['jquery'], function(require, exports, module) {
    ...
    var SearchOther = {
        ...
        getTypeImg:function(type) {
            ...
            return {url:vars.imgPath+'images/'+i+'.png', size:new BMap.Size(17,24), anchor:new BMap.Size(0, -24)};
        },
        ...
        opentip: function(marker, type) {
            ...
            var opentheTip = function(){
                ...
                if(!info) return;
                if(me.isclick && me.isclick == info.uid&&$('#maptip').css('display')=='block'){
                    me.closeTip();
                    return;
                }
                me.isclick = info.uid;
...
//                $('#maptip').innerHTML = SFUtil.templateFetch($('#tipDetail').value, info);
                    ...
                    node.html(me.templateFetch($('#searchDetail').val(), info));
                }
                node.show();
